...
(() => {
  ...
  window.SharafiAdminAPI = Object.freeze({
    ...
    products: Object.freeze({
      ...
      uploadImage: (productId, formData) => api.request(`/admin/catalog/products/${encodeURIComponent(productId)}/images`, { method: 'POST', formData }),
      updateImage: (productId, imageId, data) => api.request(`/admin/catalog/products/${encodeURIComponent(productId)}/images/${encodeURIComponent(imageId)}`, { method: 'PATCH', json: data }),
      removeImage: (productId, imageId) => api.request(`/admin/catalog/products/${encodeURIComponent(productId)}/images/${encodeURIComponent(imageId)}`, { method: 'DELETE' }),
