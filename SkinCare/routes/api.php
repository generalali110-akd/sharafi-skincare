...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::prefix('admin')->group(function (): void {
        ...
        Route::post('/catalog/categories', [AdminTaxonomyController::class, 'storeCategory'])->middleware('permission:'.Permissions::CATALOG_WRITE);
        Route::patch('/catalog/categories/{category}', [AdminTaxonomyController::class, 'updateCategory'])->middleware('permission:'.Permissions::CATALOG_WRITE);
        ...
        Route::patch('/discounts/{discountRule}', [AdminDiscountController::class, 'update'])->middleware('permission:'.Permissions::DISCOUNTS_WRITE);

        Route::get('/audit-logs', [AdminAuditLogController::class, 'index'])->middleware('permission:'.Permissions::AUDIT_READ);
    });
});
